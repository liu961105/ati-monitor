	...
	<div id="list">
		<table class="layui-table">
			...
			<tr>
				...
				<td>
					<shiro:hasPermission name="monitorType:update"><span class="oper-handle iconfont icon-bianji base-yellow update" title='修改照片类型' data-pkid={{id}}></span></shiro:hasPermission>
					<shiro:hasPermission name="monitorType:delete"><span class="oper-handle iconfont icon-shanchu base-red delete" title='删除照片类型' data-pkid={{id}}></span></shiro:hasPermission>
					<shiro:hasPermission name="monitorType:detail"><span class="oper-handle iconfont icon-xiangqing base-blue detail" title='照片类型详情' data-pkid={{id}}></span></shiro:hasPermission>
				</td>
			</tr>
			{{/each}}
		</script>
	...
	<form id="form" class="layui-form-pane">
		...
		<div class="layui-row">
			<div class="layui-col-md6">
				<div class="layui-form-item">
					<label class="layui-form-label">相册类型名称</label>
			...
			<div class="layui-col-md6">
				<div class="layui-form-item">
					<label class="layui-form-label">相册类型编号</label>
					<div class="layui-input-block">
...
$(function() {
	...
	$.baseEvent({
		...
		param:['name','strucId'],
		isPage:true,
		pageList_url:"/photoType/pageList",
		form_url:'/photoType/save',
		data_list:'${ctx}/route/manage/basedata/photo_type_list',
		del_url:'/photoType/delete',
		findBy_url:'/photoType/findById',
		add_is_dialog:true
	});
