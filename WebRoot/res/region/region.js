	         ...
	         if (newName.length == 0) {
	          ...
	          if (newName != treeNode.name) {
	             if (1==1) {
	                 ...
	                 data: "key=" + treeNode.tld + "&newName=" + newName+"&companyId="+companyId,
	                 dataType: "text",
	                 success: function (data) {
	                	 if(data=="repeat"){
	                     ...
	                     $.ajax({
	  					   ...
	  					   data: {key:treeNode.tld,companyId:companyId},
	  				       dataType: "json",
	  					   success: function(data){
	  						 var json=data;
		...
		function addHoverDom(treeId, treeNode) {
			...
			if (btn) btn.bind("click", function(){
				...
				$.ajax({
					   type: "POST",
					   url: "department/save",
					   data: "seq="+seq+"&name="+name+"&parId="+treeNode.id+"&dcode="+dcode+"&companyId="+companyId,
					   dataType : "json",
					   success: function(data){
					   		if(data.ret==1){
