...
(function ($) {
    ...
    var defaults = {
        ...
        indexPage: 1,
        totalElements:0,//共有多少条；  if  this.showtotalElements属性 为T 则该数据显示  F则无显示
        showtotalElements:false,//是否显示共有条数数据
    ...
    $.fn.Page = function (options) {
        ...
        return this.each(function () {
            ...
            if (l > 1 && l < n + 1) {
                ...
                var showFistPage,showLastPage;
                var k = Math.floor(n/2);
                if(indexPage - k <= 0){
                    showFistPage = 1;
                    showLastPage = n;
                }else if(indexPage + k > l){
                    showFistPage = indexPage - k;
                    showLastPage = l;
                }else {
                    showFistPage = indexPage - k;
                    showLastPage = indexPage +k;
                }
                for (i = showFistPage; i <= showLastPage; i++) {
                    if(i == indexPage){
                        str +=  '<li><a href="javascript:" class="' + active + '">'+i+'</a></li>';
                    }else {
                        str += '<li><a href="javascript:">' + i + '</a></li>';
                ...
                str +=  '<li><a href="javascript:" class="' + active + '">'+1+'</a></li>';
            }

            var dataHtml = '';
            if(opts.showtotalElements){
            	dataHtml += '<div style="width:auto;margin-left:0.5vw" class="zg">共' + opts.totalElements + '条</div>'
            }
            if (opts.hasNext) {
