    ...
    var obj = function(config){
        ...
        this.createOption = function(){
            ...
            for(var i=0;i<d.length;i++){
                ...
                html +=			'<span style="color: #666">'+d[i][f.titleName]+'</span><i class="layui-icon">&#xe605;</i>';
                html +=		'</div>';
                html +='</dd>';
            }
            html +=			'</dl>';
        ...
        this.setSelected = function(first){
            ...
            if(items.length==0){
                ...
                items.each(function(){
                    ...
                    values.push(v);
                    names.push(n);
                    spans.push('<a href="javascript:;" style="background-color: #172147"><span lay-value="'+v+'">'+n+'</span><i class="layui-icon">&#x1006;</i></a>');
                    selected.push(item);
                });
            }
    ...
    obj.prototype.render = function(){
        ...
        $E.on('click','dd',function(e){
            ...
            //选中
                ...
                console.log("max==="+c.max+"o.selected.length===="+o.selected.length);
