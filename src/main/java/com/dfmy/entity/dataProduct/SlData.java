...
public class SlData {
	...
	public SlData(String gcmc, String code, String gcbw, String jcyj, String zyyqsb, String sj, String jsd, String jp,
			String sl, String jcr, String jlr, String fhr, String time) {
		this.gcmc = gcmc;
		this.code = code;
		this.gcbw = gcbw;
		this.jcyj = jcyj;
