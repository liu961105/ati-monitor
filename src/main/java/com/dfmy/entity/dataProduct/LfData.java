...
public class LfData {
	...
	public LfData(String gcmc, String code, String gcbw, String jcyj, String zyyqsb, String sj, String cd, String kd,
			String fzsl, String jcr, String jlr, String fhr, String time) {
		this.gcmc = gcmc;
		this.code = code;
		this.gcbw = gcbw;
		this.jcyj = jcyj;
	...
	public void setFzsl(String fzsl) {
		this.fzsl = fzsl;
	}
